...
//        DataTypeChild dataType = new DataTypeChild();
        /*dataType.setName("Kangkang");
        dataType.setAge(18);
        dataType. setWeight(56);
        dataType.say();*/
        /*Class clazz = Class.forName("com.study.demo.TestDemo.DataType");
        ...
        String b= "不是";
        String c = "是的";
        System.out.println("相似度："+getSimilarity(a,c));*/
        Integer a1 = 59;
        int a2 = 59;
